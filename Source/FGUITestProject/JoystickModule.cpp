...
{
    Button = MainView->GetChild(TEXT("joystick"))->As<UGButton>();
    Button->bChangeStateOnClick = false;

    Thumb = Button->GetChild(TEXT("thumb"));
    TouchArea = MainView->GetChild(TEXT("joystick_touch"));
    Center = MainView->GetChild(TEXT("joystick_center"));
