...
void UGLoader3D::CreateDisplayObject()
{
	DisplayObject = Content = MakeShared<SFImage>(this);
}

UGLoader3D::~UGLoader3D() {}

void UGLoader3D::Dispose()
{
	if (bDisposed)
		return;
	Content.Reset();
...
const FString& UGLoader3D::GetURL() const
{
	return URL;
}
...
const FColor& UGLoader3D::GetColor() const
{
