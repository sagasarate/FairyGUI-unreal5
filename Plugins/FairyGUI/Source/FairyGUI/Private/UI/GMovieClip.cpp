...
void UGMovieClip::CreateDisplayObject()
{
	DisplayObject = Content = MakeShared<SMovieClip>(this);
	DisplayObject->SetInteractable(false);
}

UGMovieClip::~UGMovieClip() {}

void UGMovieClip::Dispose()
{
	if (bDisposed)
		return;
	Content.Reset();
...
void UGMovieClip::SetPlaySettings(
	int32 InStart, int32 InEnd, int32 InTimes, int32 InEndAt, const FSimpleDelegate& InCompleteCallback)
{
...
const FColor& UGMovieClip::GetColor() const
{
