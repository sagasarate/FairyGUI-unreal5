...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "FairyGUI")
    UGComponent* GetFrame() const;

    UFUNCTION(BlueprintCallable, Category = "FairyGUI")
    UGObject* GetCloseButton() const;

    UFUNCTION(BlueprintCallable, Category = "FairyGUI")
    void SetCloseButton(UGObject* Obj);

    UFUNCTION(BlueprintCallable, Category = "FairyGUI")
    UGObject* GetDragArea() const;

    UFUNCTION(BlueprintCallable, Category = "FairyGUI")
    void SetDragArea(UGObject* Obj);

    UFUNCTION(BlueprintCallable, Category = "FairyGUI")
    UGObject* GetContentArea() const;

    UFUNCTION(BlueprintCallable, Category = "FairyGUI")
    void SetContentArea(UGObject* Obj);

    UFUNCTION(BlueprintCallable, Category = "FairyGUI")
    UGObject* GetModalWaitingPane() const;
