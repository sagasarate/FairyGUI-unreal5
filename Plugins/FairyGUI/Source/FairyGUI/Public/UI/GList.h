...
public:
	...
	const FString& GetDefaultItem() const;
	UFUNCTION(BlueprintCallable, Category = "FairyGUI")
	...
	FGObjectPool* GetItemPool() const { return Pool.Get(); }
...
protected:
	...
	virtual void SetupItem(FByteBuffer* Buffer, UGObject* Obj, int32 Index);
