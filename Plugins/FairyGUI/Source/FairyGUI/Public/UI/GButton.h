...
public:
    ...
    virtual FText GetText() const override { return Title; }
    ...
    UFUNCTION(BlueprintCallable, Category = "FairyGUI")
    const FText& GetSelectedTitle() const;
    UFUNCTION(BlueprintCallable, Category = "FairyGUI")
    void SetSelectedTitle(const FText& InTitle);

    UFUNCTION(BlueprintCallable, Category = "FairyGUI")
    const FString& GetSelectedIcon() const;
    UFUNCTION(BlueprintCallable, Category = "FairyGUI")
    ...
    UFUNCTION(BlueprintCallable, Category = "FairyGUI")
    UGController* GetRelatedController() const;
    UFUNCTION(BlueprintCallable, Category = "FairyGUI")
