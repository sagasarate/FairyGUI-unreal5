...
struct FXMLAttributes : TMap<FString, FString>
{
	...
	void Set(const FString& AttrName, const FString& Value);
	void Set(const FString& AttrName, int32 Value);
	void Set(const FString& AttrName, float Value);
	void Set(const FString& AttrName, bool Value);
	void Set(const FString& AttrName, const FColor& Value);
};